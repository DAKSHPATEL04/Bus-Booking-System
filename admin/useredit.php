    ...
    <div class="form">
       <div class="inputfield"> 
                    <form action="usercode.php" method="POST">
                                    ...
                                    $query = "SELECT * FROM userss WHERE id='$user_id'";
                                             ...
                                             ?>
                                                <div class="inputfield">
                                                  <input type="hidden" name="user_id" class="input" value="<?php echo $row['id']; ?>">
                                                        ...
                                                        <input type="text" name="name" class="input" value="<?php echo $row['name']; ?>"  minlength="3" maxlength="12" placeholder="name" required>
                                                        </div>
