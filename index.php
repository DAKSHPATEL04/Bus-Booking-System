...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Position the image coverer (needed to position the left and right arrows) */
    .coverer {
      position: relative;
    }
...
<body>
  ...
  <script>
    ...
    darkModeToggle.addEventListener('click', () => {
      ...
      const currentTheme = body.classList.covers('dark-mode') ? 'dark' : 'light';
